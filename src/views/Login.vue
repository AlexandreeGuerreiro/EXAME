            ...
            <section class="contact-page-area section-gap">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <form class="form-area contact-form text-right" id="myForm" @submit.prevent="login">
                                <div class="row">
                                    <div class="col-lg-6 form-group">
                                        ...
                                        <input v-model="user.password" name="password" placeholder="Enter password"
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <button type="submit" class="genric-btn primary" style="float: left;">Login</button>
                                    </div>
                                </div>
                            </form>
                        </div>
